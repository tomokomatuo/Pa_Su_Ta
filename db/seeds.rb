...
User.create!(nickname: 'けんいち', image:File.open("./db/fixtures/cat.jpg"), content: '初めまして。健太郎と申します。洋服が大好きで、友達にコーディネートするのが得意です。私のアドバイスで、違った自分を発見してください！', birthday: '1998-12-11', age: '３０代', gender: '男性', email: 'kenichi11@gmail.com', password: 'password', password_confirmation: 'password', name: '相模健太郎', address: '新宿', adviser: true, phone_number: 8011111111)
User.create!(nickname: 'けんじ', image:File.open("./db/fixtures/dog.jpg"), content: 'こんにちは＾＾着こなしがわからない人は結局自分がわかっていないのと同じです。着こなしを理解して、自分をもっと理解しましょう。', birthday: '1985-12-11', age: '３０代', gender: '男性', email: 'kenj11@gmail.com', password: 'password', password_confirmation: 'password', name: '相模健太郎', address: '新宿', adviser: true, phone_number: 8011111112)
